...
void GameManager::_load_level(const u32 level) {
    ...
    chopper.add_tag(constants::PLAYER_TAG);
    ...
    chopper.add_component<component::BoxCollider>(32u, 32u);
    ...
    tank.add_group(constants::ENEMY_GROUP);
